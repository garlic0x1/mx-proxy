...
(defmethod create-list-inspector (obj value callback)
  (let ((obj (create-div obj)))
...
(defmethod create-vector-inspector (obj value callback)
  (let ((obj (create-div obj)))
    (create-primitive-inspector obj value callback)
    (create-br obj)
...
(defmethod create-object-inspector (obj value callback)
  (let ((obj (create-div obj)))
    (create-primitive-inspector obj value callback)
    (create-br obj)
    (let* ((table (create-table obj :class *table-class*))
